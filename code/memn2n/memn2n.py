...
class MemN2N(object):
    ...
    def _build_inputs(self):
        ''' Specify the inputs of the neural network graph,
        which are three placeholders for three tensors.
        The three tensors are for the context, questions and answers.
        '''
